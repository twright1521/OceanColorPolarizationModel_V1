function [a_phy,a_CDOM,a_NAP,b_phy,bb_phy,b_NAP,bb_NAP,a_water,bb_water,b_water] = getAbsorptionBackscatteringVersion1(CHL,wav)
...
%% Interpolating Data
a_pico = interp1(wav_pico,a_pico_file,wav,'linear','extrap');
a_micro = interp1(wav_pico,a_micro_file,wav,'linear','extrap');

a_water = interp1(wav_water,a_water_file,wav,'linear','extrap');
bb_water = interp1(wav_water,bb_water_file,wav,'linear','extrap');
